...
class AppServiceProvider extends ServiceProvider
{
    ...
    public function boot(): void
    {
        if ($pengaturan = Pengaturan::first()) {
            ...
            Config::set('adminlte.anjungan_qr', $pengaturan->anjungan_qr ? asset('storage/pengaturan/' . $pengaturan->anjungan_qr) : asset('img/image-placeholder.jpg'));
            Config::set('adminlte.anjungan_img_info', $pengaturan->anjungan_img_info ? asset('storage/pengaturan/' . $pengaturan->anjungan_img_info) : asset('img/image-placeholder.jpg'));
        }
    }
}
