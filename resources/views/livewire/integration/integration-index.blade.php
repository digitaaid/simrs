                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <x-adminlte-input wire:model="slug" fgroup-class="row" label-class="text-left col-3"
                                    ...
                                    placeholder="slug" />
                                <x-adminlte-input wire:model="description" fgroup-class="row"
                            ...
                            <div class="col-md-6">
                                ...
                                <x-adminlte-input wire:model="secret_key" fgroup-class="row"
                                    label-class="text-left col-3" igroup-class="col-9" igroup-size="sm"
                                    name="secret_key" label="secret_key" placeholder="secret_key" />
                            </div>
                        </div>
