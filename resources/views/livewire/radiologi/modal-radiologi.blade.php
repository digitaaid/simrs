<div>
    <x-adminlte-card theme="primary" title="Riwayat Radiologi">
        @if (flash()->message)
                        ...
                        <tr>
                            <td colspan="5">
                                <a href="{{ route('landingpage') . '/public/storage/laboratorium/' . $item->filename }}"
                                    target="_blank">{{ route('landingpage') . '/public/storage/laboratorium/' . $item->filename }}</a>
                                    <br>
