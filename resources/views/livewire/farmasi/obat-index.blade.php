<div class="row">
    <div class="col-md-12">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <x-adminlte-input wire:model="harga_beli" fgroup-class="row" label-class="text-left col-4"
                                ...
                                label="harga_beli" />
                            <x-adminlte-input wire:model="harga_jual" fgroup-class="row" label-class="text-left col-4"
                                igroup-class="col-8" igroup-size="sm" name="harga_jual" type="number"
                                label="harga_jual" />
                            <x-adminlte-input wire:model="harga_bpjs" fgroup-class="row" label-class="text-left col-4"
                            ...
                            <x-adminlte-input wire:model="distributor" fgroup-class="row" label-class="text-left col-4"
                            ...
                            <x-adminlte-input wire:model="barcode" fgroup-class="row" label-class="text-left col-4"
        ...
        @endif
        <x-adminlte-card title="Table Obat" theme="secondary">
            <div class="row ">
                <div class="col-md-8">
