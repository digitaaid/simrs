<div>
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <x-adminlte-input wire:model="jam_masuk" fgroup-class="row" type="time"
                            label-class="text-left col-4" igroup-class="col-8" igroup-size="sm" name="jam_masuk"
                            label="Jam Masuk" />
                        <x-adminlte-input wire:model="jam_pulang" fgroup-class="row" type="time"
                            label-class="text-left col-4" igroup-class="col-8" igroup-size="sm" name="jam_pulang"
                            label="Jam Pulang" />
                    </div>
                </div>
            </form>
    ...
    <x-adminlte-card title="Jadwal Shift Kerja" theme="primary">
        <div class="row ">
            <div class="col-md-8">
                <x-adminlte-button wire:click='tambah' class="btn-sm mb-2" label="Tambah Shift Kerja" theme="success"
                    icon="fas fa-user-plus" />
                <x-adminlte-button wire:click='export'
                    wire:confirm='Apakah anda yakin akan mendownload data semua obat ? ' class="btn-sm mb-2" label="Export"
                    theme="primary" icon="fas fa-upload" />
