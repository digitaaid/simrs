<div class="row">
    ...
    @endif
    <div class="col-md-12">
        <x-adminlte-card title="Monitoring Data Klaim" theme="secondary">
            <div class="row">
                <div class="col-md-3">
                ...
                <div class="col-md-3">
                    <x-adminlte-select wire:model="statusklaim" fgroup-class="row" label-class="text-left col-4"
                        igroup-class="col-8" igroup-size="sm" name="statusklaim">
                        <option value=null disabled>Pilih Jenis Pelayanan</option>
                        <option value="1">Proses Verfikasi</option>
