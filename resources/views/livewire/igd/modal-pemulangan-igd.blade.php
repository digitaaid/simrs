<div>
    <x-adminlte-card theme="primary" title="Pemulangan Pasien" icon="fas fa-ambulance">
        ...
        <x-slot name="footerSlot">
            ...
            <x-adminlte-button theme="warning" icon="fas fa-bed" class="btn-sm" label="Transfer Ranap"
                wire:click="openForm" />
            <div wire:loading>
    ...
    @if ($form)
        <x-modal size="xl" title="Transfer Rawat Inap" icon="fas fa-user-injured" theme="dark">
            <div class="row">
                <div class="col-md-6">
                    ...
                    <x-adminlte-input wire:model='nik' name="nik" fgroup-class="row"
            ...
            <x-slot name="footerSlot">
                <x-adminlte-button theme="success" icon="fas fa-bed" class="btn-sm" label="Transfer"
                    wire:click="transfer" wire:confirm='Apakah anda yakin akan mentransfer pasien ke rawat inap ?' />
