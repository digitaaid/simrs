            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <div wire:loading.remove>
                        @if ($pasien)
                            <b>NIK :</b> {{ $pasien->norm ?? '-' }} <br>
                            <b>Nama :</b> {{ $pasien->nama ?? '-' }} <br>
                            <b>Tgl Lahir :</b> {{ $pasien->tempat_lahir ?? '-' }} , {{ $pasien->tgl_lahir ?? '-' }}<br>
                            <b>Gender :</b> {{ $pasien->gender == 'L' ? 'Laki-Laki' : 'Perempuan' }} <br>
                        @endif
                    </div>
                </div>
                @if ($pasien)
                    <div class="col-md-12">
                        <iframe src="{{ route('print.label.pasien') }}?norm={{ $pasien->norm }}"
