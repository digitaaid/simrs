        ...
        [
            ...
            'submenu' => [
                [
                    ...
                    'url' => 'pelayanan-igd/pendaftaran',
                    'icon' => 'fas fa-user-plus',
                    'shift'   => 'ml-2',
                    // 'can' => 'pelayanan-igd-pendaftaran',
                    'active'  => ['pelayanan-igd/pendaftaran', 'pelayanan-igd/pendaftaran/proses/*'],
                ],
                [
                    'text' => 'Keperawatan IGD',
                    'url' => 'pelayanan-igd/keperawatan',
                    'icon' => 'fas fa-user-nurse',
                    'shift'   => 'ml-2',
                    // 'can' => 'pelayanan-igd-keperawatan',
                    'active'  => ['pelayanan-igd/keperawatan', 'pelayanan-igd/keperawatan/proses/*'],
                ],
                [
                    'text' => 'Pemeriksaan IGD',
                    'url' => 'pelayanan-igd/pemeriksaan',
                    'icon' => 'fas fa-user-md',
                    'shift'   => 'ml-2',
                    // 'can' => 'pelayanan-igd-pemeriksaan',
                    'active'  => ['pelayanan-igd/pemeriksaan', 'pelayanan-igd/pemeriksaan/proses/*'],
                ],
                [
                    'text' => 'Farmasi IGD',
                    'url' => 'pelayanan-igd/farmasi',
                    'icon' => 'fas fa-pills',
                    'shift'   => 'ml-2',
                    // 'can' => 'pelayanan-igd-farmasi',
                    'active'  => ['pelayanan-igd/farmasi', 'pelayanan-igd/farmasi/proses/*'],
                ],
                [
                    'text' => 'Kasir IGD',
                    'url' => 'pelayanan-igd/kasir',
                    'icon' => 'fas fa-cash-register',
                    'shift'   => 'ml-2',
                    // 'can' => 'pelayanan-igd-kasir',
                    'active'  => ['pelayanan-igd/kasir', 'pelayanan-igd/kasir/proses'],
                ],
            ]
        ],
        // RAWAT INAP
